...
public class EvenementService {
    ...
    public void doWork() {
        ...
        Utilisateur user = new Utilisateur("tester", "test", "test", "test", maDate,"USER_ADMIN");
        userRepo.save(user);
        ...
        Evenement e1 = new Evenement(maDate, "e1", monTemp , "France", 0,user );
        Evenement e2 = new Evenement(maDate, "e2", monTemp , "France", 0,user );
        eventRepo.save(e1);
        eventRepo.save(e2);
